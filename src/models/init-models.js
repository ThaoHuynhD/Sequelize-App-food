...
export default function initModels(sequelize) {
  ...
  const orderr = _orderr.init(sequelize, DataTypes);
  ...
  orderr.belongsTo(users, { as: "user", foreignKey: "user_id"});
  users.hasMany(orderr, { as: "orderrs", foreignKey: "user_id"});
